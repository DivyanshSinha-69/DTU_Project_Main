        ...
        <div className="flex flex-row justify-between pr-5 pl-5">
          ...
          >
            <div className="h-[575px] w-[auto] md:w-[500px] md:mx-auto bg-gray-800 opacity-[0.8] rounded-[12%] top-10 fixed inset-5 md:inset-20 flex items-center justify-center">
              <EntrepreneurPopup
                companyName={
                  TABLE_ROWS.length > 0 ? TABLE_ROWS[0].companyName : ""
                }
                cinNumber={TABLE_ROWS.length > 0 ? TABLE_ROWS[0].cinNumber : ""}
                companyLink={
                  TABLE_ROWS.length > 0 ? TABLE_ROWS[0].companyLink : ""
                }
                      ...
                      <tr key={RollNo}>
                        ...
                        <td className={classes}>
                          ...
                          >
                            ...
                            >
                              <img
                                className="ml-[20px] md:ml-[70px] h-5 w-10 hover:invert hover:scale-125 transition-transform ease-in "
                                src={linkImg}
                                alt="link"
                              ></img>
                            </a>
