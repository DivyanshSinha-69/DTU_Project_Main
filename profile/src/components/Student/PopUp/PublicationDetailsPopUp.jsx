...
export default function PublicationPopUp({
  ...
  const handleSubmit = (e) => {
    ...
    handleAddPublicationDetails(formData, file);
  };
      ...
      >
        <div className="overflow-y-auto flex-1 p-6">
          ...
          >
            ...
            {/* ISSN Number */}
            <div className="relative z-0 w-full group">
              <label htmlFor="issn" className="block text-sm">
            ...
            {/* UGC */}
            <div className="relative z-0 w-full group">
              <label htmlFor="ugc" className="block text-sm">
                UGC Approved <span className="text-red-500">*</span>
              </label>
              <select
                name="ugc"
                className="block py-3 px-4 w-full text-sm bg-gray-800 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
