...
const Acknowledgement = () => {
  const handleAcknowledgement = () => {
    alert("Acknowledgement functionality has been disabled");
  };

  return (
    <div className="p-4 border rounded-lg bg-gray-50">
      <h2 className="text-lg font-bold mb-4">Acknowledgement Component</h2>
      <p className="mb-4 text-gray-600">
        This component previously generated PDF acknowledgements but that
        functionality has been removed.
      </p>
      <button
        onClick={handleAcknowledgement}
        className="font1 rounded-lg text-white font-xl bg-gray-600 p-3 hover:bg-gray-500 hover:scale-[104%] transition-transform ease-in"
      >
