...
const InterInstituteCertificates = ({ setPdfSrc, setId }) => {
    ...
    if (file && id) {
      ...
      try {
        const response = await axios.post(
          `${process.env.REACT_APP_BACKEND_URL}/ece/student/uploadcertificate`,
          formData,
          {
            headers: {
      ...
      axios
        .post(`${process.env.REACT_APP_BACKEND_URL}/ece/student/getcertificate`, { id: id })
        .then((response) => {
...
export default InterInstituteCertificates;
