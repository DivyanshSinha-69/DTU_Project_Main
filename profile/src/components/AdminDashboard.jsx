...
//   return (
//     <>
//    <div className='mt-10 h-auto flex justify-center items-center'>
      ...
      <div className="mt-10 h-auto md:h-screen flex justify-center items-center">
        <div className="w-11/12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <figure onClick= className="flex flex-col items-center justify-center p-8 text-center border-b border-r border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-ss-lg md:border-e dark:border-gray-700">
            ...
            <figure className="flex flex-col items-center justify-center p-8 text-center border-b border-r border-gray-200 dark:border-gray-700">
