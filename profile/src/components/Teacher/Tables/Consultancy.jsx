...
const ConsultancyDetails = ({ setBlurActive }) => {
  ...
  const fetchConsultancyDetails = async () => {
    try {
      const response = await fetch(
        `https://64.227.135.99:3001/ece/faculty/consultancy/FAC001`,
  ...
  const handleAddConsultancy = async (newConsultancy) => {
    try {
      if (isAddConsultancy) {
        // Add new consultancy
        await axios.post("https://64.227.135.99:3001/ece/faculty/consultancy", {
        ...
        await axios.put(
          `https://64.227.135.99:3001/ece/faculty/consultancy/${selectedConsultancy.consultancy_id}`,
          {
            faculty_id: "FAC001", // Hardcoded for now
            project_title: newConsultancy.title,
  ...
  const handleDeleteConsultancy = async (indexToDelete) => {
    ...
    try {
      await axios.delete(
        `https://64.227.135.99:3001/ece/faculty/consultancy/${consultancyToDelete.consultancy_id}`,
      );
