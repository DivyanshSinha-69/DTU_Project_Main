  ...
  const saveProject = (project) => {
    if (editProject) {
      ...
      setResearchProjectsDetails((prevDetails) =>
        prevDetails.map((p) =>
          p.SerialNo === project.SerialNo ? project : p
        )
      );
    } else {
      // Add a new project
    ...
    <div>
      <div className="h-auto p-10">
        <div className="flex flex-row justify-between pr-5 pl-5">
          <p className="p-3 text-2xl font1 border-top my-auto">Research Projects</p>
          <button
            onClick={() => openPopup()}
          ...
          <table className="w-full min-w-auto lg:min-w-max table-auto text-left">
            ...
            <tbody>
              {researchProjectsDetails.map(
                (
                  { SerialNo, Title, Domain, PublicationName, PublishedDate, PublishedLink },
                  index
                ) => {
                  ...
                  return (
                    <tr key={SerialNo}>
                      ...
                      <td className={classes}>
                        <Typography variant="small" color="blue-gray" className="font-normal">
                          <a href={PublishedLink} target="_blank" className="hover:underline">
                            <img
                      ...
                      <td className={classes}>
                        <button
                          onClick={() => openPopup({ SerialNo, Title, Domain, PublicationName, PublishedDate, PublishedLink })}
