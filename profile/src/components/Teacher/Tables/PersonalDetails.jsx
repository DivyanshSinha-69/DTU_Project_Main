...
const PersonalDetails = ({ setBlurActive }) => {
  ...
  const fetchSpecializations = async () => {
    try {
      const response = await fetch(
        `https://64.227.135.99:3001/ece/faculty/specializations/FAC001`,
      );
  ...
  const addSpecialization = async () => {
    ...
    try {
      const response = await fetch(
        "https://64.227.135.99:3001/ece/faculty/specializations",
        {
          method: "POST",
  ...
  const deleteSpecialization = async (specialization_id) => {
    try {
      const response = await fetch(
        `https://64.227.135.99:3001/ece/faculty/specializations/${specialization_id}`,
        {
          method: "DELETE",
        },
      );
