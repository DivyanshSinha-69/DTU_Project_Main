...
const dummyOrders = [
  ...
  // Adding 100 more dummy orders
  ...Array.from({ length: 100 }, (_, i) => ({
    order_id: i + 3,
    order_number: `ORD${(i + 3).toString().padStart(3, "0")}`,
    department_id: `DEPT00${(i % 5) + 1}`,
    order_name: `Generated Order ${i + 3}`,
    order_date: `2023-${(i % 12) + 1}-01`,
    start_date: `2023-${(i % 12) + 1}-05`,
    end_date: `2023-${(i % 12) + 1}-10`,
    subject: `Auto-generated subject for order ${i + 3}.`,
    order_path: `orders/generated-order-${i + 3}.pdf`,
  })),
];
  ...
  return (
    ...
    >
      {loader ? (
        ...
        <>
          <DepartmentHeader /> {/* Add the Header here */}
